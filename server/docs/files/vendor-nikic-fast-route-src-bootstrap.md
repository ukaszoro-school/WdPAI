...
<h3 id="toc">
    Table of Contents
    <a href="files/vendor-nikic-fast-route-src-bootstrap.html#toc" class="headerlink"><i class="fas fa-link"></i></a>
    ...
    <div class="phpdocumentor-modal-container">
        <div class="phpdocumentor-modal-content">
            <pre style="max-height: 500px; overflow-y: scroll" data-src="files/vendor/nikic/fast-route/src/bootstrap.php.txt" class="language-php line-numbers linkable-line-numbers"></pre>
        </div>
    ...
    <section class="phpdocumentor-search-results__dialog">
        ...
        <a href="files/vendor-nikic-fast-route-src-bootstrap.html#top" class="phpdocumentor-back-to-top"><i class="fas fa-chevron-circle-up"></i></a>
