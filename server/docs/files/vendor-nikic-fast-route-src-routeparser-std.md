...
<aside class="phpdocumentor-column -three phpdocumentor-sidebar">
    ...
    <article class="phpdocumentor-element -file">
        <h2 class="phpdocumentor-content__title">Std.php</h2>
...
<h3 id="toc">
    Table of Contents
    <a href="files/vendor-nikic-fast-route-src-routeparser-std.html#toc" class="headerlink"><i class="fas fa-link"></i></a>
    ...
    <h4 id="toc-classes">
        Classes
        <a href="files/vendor-nikic-fast-route-src-routeparser-std.html#toc-classes" class="headerlink"><i class="fas fa-link"></i></a>

    </h4>
    <dl class="phpdocumentor-table-of-contents">
                    <dt class="phpdocumentor-table-of-contents__entry -class"><a href="classes/FastRoute-RouteParser-Std.html"><abbr title="\FastRoute\RouteParser\Std">Std</abbr></a></dt><dd>Parses route strings of the following form:</dd>    </dl>
    ...
    <section class="phpdocumentor-on-this-page__content">
        ...
        <ul class="phpdocumentor-list -clean">
            ...
            <li>
                <ul class="phpdocumentor-list -clean">
                                                                                                        <li><a href="files/vendor-nikic-fast-route-src-routeparser-std.html#toc-classes">Classes</a></li>
                                                                                                                    </ul>
            </li>
    ...
    <section class="phpdocumentor-search-results__dialog">
        ...
        <a href="files/vendor-nikic-fast-route-src-routeparser-std.html#top" class="phpdocumentor-back-to-top"><i class="fas fa-chevron-circle-up"></i></a>
