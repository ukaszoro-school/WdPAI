...
<aside class="phpdocumentor-column -three phpdocumentor-sidebar">
    ...
    <ul class="phpdocumentor-list">
                ...
                <a href="namespaces/app-database.html" class="">Database</a>
                    ...
                    <li>
                <a href="namespaces/app-http.html" class="-active">Http</a>
...
<h3 id="toc">
    Table of Contents
    <a href="namespaces/app-http.html#toc" class="headerlink"><i class="fas fa-link"></i></a>
    ...
    <h4 id="toc-classes">
        Classes
        <a href="namespaces/app-http.html#toc-classes" class="headerlink"><i class="fas fa-link"></i></a>

    </h4>
    <dl class="phpdocumentor-table-of-contents">
                    <dt class="phpdocumentor-table-of-contents__entry -class"><a href="classes/App-Http-Csp.html"><abbr title="\App\Http\Csp">Csp</abbr></a></dt>            <dt class="phpdocumentor-table-of-contents__entry -class"><a href="classes/App-Http-StaticFileServer.html"><abbr title="\App\Http\StaticFileServer">StaticFileServer</abbr></a></dt>    </dl>
    ...
    <section class="phpdocumentor-on-this-page__content">
        ...
        <ul class="phpdocumentor-list -clean">
            ...
            <li>
                <ul class="phpdocumentor-list -clean">
                                                                                                    <li><a href="namespaces/app-http.html#toc-classes">Classes</a></li>
                                                                                                                    </ul>
            </li>
    ...
    <section class="phpdocumentor-search-results__dialog">
        ...
        <a href="namespaces/app-http.html#top" class="phpdocumentor-back-to-top"><i class="fas fa-chevron-circle-up"></i></a>
