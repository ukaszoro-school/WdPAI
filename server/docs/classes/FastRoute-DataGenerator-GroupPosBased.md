...
<div class="phpdocumentor-label-line">
    ...
    <abbr class="phpdocumentor-element-found-in__file" title="vendor/nikic/fast-route/src/DataGenerator/GroupPosBased.php"><a href="files/vendor-nikic-fast-route-src-datagenerator-groupposbased.html"><abbr title="vendor/nikic/fast-route/src/DataGenerator/GroupPosBased.php">GroupPosBased.php</abbr></a></abbr>
    :
...
<h3 id="toc">
    Table of Contents
    <a href="classes/FastRoute-DataGenerator-GroupPosBased.html#toc" class="headerlink"><i class="fas fa-link"></i></a>
...
<h4 id="toc-properties">
    Properties
    <a href="classes/FastRoute-DataGenerator-GroupPosBased.html#toc-properties" class="headerlink"><i class="fas fa-link"></i></a>
...
<h4 id="toc-methods">
    Methods
    <a href="classes/FastRoute-DataGenerator-GroupPosBased.html#toc-methods" class="headerlink"><i class="fas fa-link"></i></a>
...
depends on the used method of dispatch.</dd>
    ...
    <a class="" href="classes/FastRoute-DataGenerator-GroupPosBased.html#method_getApproxChunkSize">getApproxChunkSize()</a>
    <span>
                                &nbsp;: int    </span>
</dt>

            <dt class="phpdocumentor-table-of-contents__entry -method -protected">
    <a class="" href="classes/FastRoute-DataGenerator-GroupPosBased.html#method_processChunk">processChunk()</a>
    <span>
                                &nbsp;: array&lt;string|int, mixed&gt;    </span>
</dt>
    ...
    <section class="phpdocumentor-properties">
        <h3 class="phpdocumentor-elements__header" id="properties">
            Properties
            <a href="classes/FastRoute-DataGenerator-GroupPosBased.html#properties" class="headerlink"><i class="fas fa-link"></i></a>
    ...
    <span class="phpdocumentor-signature__name">$staticRoutes</span>
     = <span class="phpdocumentor-signature__default-value">[]</span></code>
        ...
        <h3 class="phpdocumentor-elements__header" id="methods">
            Methods
            <a href="classes/FastRoute-DataGenerator-GroupPosBased.html#methods" class="headerlink"><i class="fas fa-link"></i></a>
...
>
    <h4 class="phpdocumentor-element__name" id="method_getApproxChunkSize">
        getApproxChunkSize()
        <a href="classes/FastRoute-DataGenerator-GroupPosBased.html#method_getApproxChunkSize" class="headerlink"><i class="fas fa-link"></i></a>
...
>
    <h4 class="phpdocumentor-element__name" id="method_processChunk">
        processChunk()
        <a href="classes/FastRoute-DataGenerator-GroupPosBased.html#method_processChunk" class="headerlink"><i class="fas fa-link"></i></a>
    ...
    <div class="phpdocumentor-modal-container">
        <div class="phpdocumentor-modal-content">
            <pre style="max-height: 500px; overflow-y: scroll" data-src="files/vendor/nikic/fast-route/src/DataGenerator/GroupPosBased.php.txt" class="language-php line-numbers linkable-line-numbers"></pre>
        </div>
    ...
    <section class="phpdocumentor-on-this-page__content">
        ...
        <ul class="phpdocumentor-list -clean">
            ...
            <li>
                <ul class="phpdocumentor-list -clean">
                                                            <li><a href="classes/FastRoute-DataGenerator-GroupPosBased.html#toc-properties">Properties</a></li>
                                                            <li><a href="classes/FastRoute-DataGenerator-GroupPosBased.html#toc-methods">Methods</a></li>
                                    </ul>
            </li>
            ...
            <li>
                <ul class="phpdocumentor-list -clean">
                                            ...
                                            <li class=""><a href="classes/FastRoute-DataGenerator-GroupPosBased.html#method_getApproxChunkSize">getApproxChunkSize()</a></li>
                                            <li class=""><a href="classes/FastRoute-DataGenerator-GroupPosBased.html#method_processChunk">processChunk()</a></li>
                                    </ul>
            </li>
                    </ul>
    </section>
    ...
    <section class="phpdocumentor-search-results__dialog">
        ...
        <a href="classes/FastRoute-DataGenerator-GroupPosBased.html#top" class="phpdocumentor-back-to-top"><i class="fas fa-chevron-circle-up"></i></a>
