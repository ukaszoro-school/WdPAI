...
<aside class="phpdocumentor-column -three phpdocumentor-sidebar">
    ...
    <abbr class="phpdocumentor-element-found-in__file" title="vendor/nikic/fast-route/src/RouteParser.php"><a href="files/vendor-nikic-fast-route-src-routeparser.html"><abbr title="vendor/nikic/fast-route/src/RouteParser.php">RouteParser.php</abbr></a></abbr>
    :
...
<h3 id="toc">
    Table of Contents
    <a href="classes/FastRoute-RouteParser.html#toc" class="headerlink"><i class="fas fa-link"></i></a>
...
<h4 id="toc-methods">
    Methods
    <a href="classes/FastRoute-RouteParser.html#toc-methods" class="headerlink"><i class="fas fa-link"></i></a>

</h4>
<dl class="phpdocumentor-table-of-contents">
            <dt class="phpdocumentor-table-of-contents__entry -method -public">
    <a class="" href="classes/FastRoute-RouteParser.html#method_parse">parse()</a>
    <span>
...
<dd>Parses a route string into multiple route data arrays.</dd>
        ...
        <h3 class="phpdocumentor-elements__header" id="methods">
            Methods
            <a href="classes/FastRoute-RouteParser.html#methods" class="headerlink"><i class="fas fa-link"></i></a>
...
>
    <h4 class="phpdocumentor-element__name" id="method_parse">
        parse()
        <a href="classes/FastRoute-RouteParser.html#method_parse" class="headerlink"><i class="fas fa-link"></i></a>
    ...
    <span class="phpdocumentor-signature__visibility">public</span>
                    <span class="phpdocumentor-signature__name">parse</span><span>(</span><span class="phpdocumentor-signature__argument"><span class="phpdocumentor-signature__argument__return-type">string&nbsp;</span><span class="phpdocumentor-signature__argument__name">$route</span></span><span>)</span><span> : </span><span class="phpdocumentor-signature__response_type">array&lt;string|int, array&lt;string|int, mixed&gt;&gt;</span></code>
...
<p>Here one route string was converted into two route data arrays.</p>
    ...
    <div class="phpdocumentor-modal-container">
        <div class="phpdocumentor-modal-content">
            <pre style="max-height: 500px; overflow-y: scroll" data-src="files/vendor/nikic/fast-route/src/RouteParser.php.txt" class="language-php line-numbers linkable-line-numbers"></pre>
        </div>
    ...
    <section class="phpdocumentor-on-this-page__content">
        ...
        <ul class="phpdocumentor-list -clean">
            ...
            <li>
                <ul class="phpdocumentor-list -clean">
                    <li><a href="classes/FastRoute-RouteParser.html#toc-constants">Constants</a></li>
                    <li><a href="classes/FastRoute-RouteParser.html#toc-methods">Methods</a></li>
                </ul>
            </li>
                            <li class="phpdocumentor-on-this-page-section__title">Methods</li>
                <li>
                    <ul class="phpdocumentor-list -clean">
                                                    <li class=""><a href="classes/FastRoute-RouteParser.html#method_parse">parse()</a></li>
                                            </ul>
                </li>
    ...
    <section class="phpdocumentor-search-results__dialog">
        ...
        <a href="classes/FastRoute-RouteParser.html#top" class="phpdocumentor-back-to-top"><i class="fas fa-chevron-circle-up"></i></a>
