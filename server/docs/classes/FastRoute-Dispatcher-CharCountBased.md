...
<div class="phpdocumentor-label-line">
    ...
    <abbr class="phpdocumentor-element-found-in__file" title="vendor/nikic/fast-route/src/Dispatcher/CharCountBased.php"><a href="files/vendor-nikic-fast-route-src-dispatcher-charcountbased.html"><abbr title="vendor/nikic/fast-route/src/Dispatcher/CharCountBased.php">CharCountBased.php</abbr></a></abbr>
    :
...
<h3 id="toc">
    Table of Contents
    <a href="classes/FastRoute-Dispatcher-CharCountBased.html#toc" class="headerlink"><i class="fas fa-link"></i></a>
...
<h4 id="toc-properties">
    Properties
    <a href="classes/FastRoute-Dispatcher-CharCountBased.html#toc-properties" class="headerlink"><i class="fas fa-link"></i></a>
...
<h4 id="toc-methods">
    Methods
    <a href="classes/FastRoute-Dispatcher-CharCountBased.html#toc-methods" class="headerlink"><i class="fas fa-link"></i></a>

</h4>
<dl class="phpdocumentor-table-of-contents">
            <dt class="phpdocumentor-table-of-contents__entry -method -public">
    <a class="" href="classes/FastRoute-Dispatcher-CharCountBased.html#method___construct">__construct()</a>
    <span>
                                &nbsp;: mixed    </span>
</dt>
...
<dd>Dispatches against the provided HTTP method verb and URI.</dd>
    ...
    <a class="" href="classes/FastRoute-Dispatcher-CharCountBased.html#method_dispatchVariableRoute">dispatchVariableRoute()</a>
    <span>
                                &nbsp;: array&lt;string|int, mixed&gt;    </span>
</dt>
    ...
    <section class="phpdocumentor-properties">
        <h3 class="phpdocumentor-elements__header" id="properties">
            Properties
            <a href="classes/FastRoute-Dispatcher-CharCountBased.html#properties" class="headerlink"><i class="fas fa-link"></i></a>
    ...
    <span class="phpdocumentor-signature__name">$variableRouteData</span>
     = <span class="phpdocumentor-signature__default-value">[]</span></code>
        ...
        <h3 class="phpdocumentor-elements__header" id="methods">
            Methods
            <a href="classes/FastRoute-Dispatcher-CharCountBased.html#methods" class="headerlink"><i class="fas fa-link"></i></a>
...
>
    <h4 class="phpdocumentor-element__name" id="method___construct">
        __construct()
        <a href="classes/FastRoute-Dispatcher-CharCountBased.html#method___construct" class="headerlink"><i class="fas fa-link"></i></a>
...
>
    <h4 class="phpdocumentor-element__name" id="method_dispatchVariableRoute">
        ...
        <a href="classes/FastRoute-Dispatcher-CharCountBased.html#method_dispatchVariableRoute" class="headerlink"><i class="fas fa-link"></i></a>
    ...
    <div class="phpdocumentor-modal-container">
        <div class="phpdocumentor-modal-content">
            <pre style="max-height: 500px; overflow-y: scroll" data-src="files/vendor/nikic/fast-route/src/Dispatcher/CharCountBased.php.txt" class="language-php line-numbers linkable-line-numbers"></pre>
        </div>
    ...
    <section class="phpdocumentor-on-this-page__content">
        ...
        <ul class="phpdocumentor-list -clean">
            ...
            <li>
                <ul class="phpdocumentor-list -clean">
                                                            <li><a href="classes/FastRoute-Dispatcher-CharCountBased.html#toc-properties">Properties</a></li>
                                                            <li><a href="classes/FastRoute-Dispatcher-CharCountBased.html#toc-methods">Methods</a></li>
                                    </ul>
            </li>
            ...
            <li>
                <ul class="phpdocumentor-list -clean">
                                            <li class=""><a href="classes/FastRoute-Dispatcher-CharCountBased.html#method___construct">__construct()</a></li>
                                            <li class=""><a href="classes/FastRoute-Dispatcher-RegexBasedAbstract.html#method_dispatch">dispatch()</a></li>
                                            <li class=""><a href="classes/FastRoute-Dispatcher-CharCountBased.html#method_dispatchVariableRoute">dispatchVariableRoute()</a></li>
                                    </ul>
            </li>
                    </ul>
    </section>
    ...
    <section class="phpdocumentor-search-results__dialog">
        ...
        <a href="classes/FastRoute-Dispatcher-CharCountBased.html#top" class="phpdocumentor-back-to-top"><i class="fas fa-chevron-circle-up"></i></a>
